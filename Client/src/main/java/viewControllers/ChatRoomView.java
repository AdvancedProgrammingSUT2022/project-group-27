...
public class ChatRoomView extends Application {
    ...
    private void firstInitialize() {
        ...
        for (ChatGroup chatGroup: ChatGroup.listOfGroupsWithUser(UserController.getInstance().getUserLoggedIn())) {
            if (chatGroup.getName().equals("")) {
                String user = chatGroup.getOtherUser(UserController.getInstance().getUserLoggedIn());
