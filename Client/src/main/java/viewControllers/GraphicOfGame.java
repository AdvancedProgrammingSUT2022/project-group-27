...
public class GraphicOfGame extends Application {
    ...
    public void initializing() { //TODO it should run at every steps, every moves and ...
        ...
        player.setText("player: " + playerInstance.getUser());
        turn.setText("year: " + Player.getYear());
        if (playerInstance.getUnderConstructionTechnology() != null) {
            technology.setText("technology: " + playerInstance.getUnderConstructionTechnology().getTechnologyType().name() +
                    "\n turns: " + (playerInstance.getUnderConstructionTechnology().getTimeRemain() +
                    playerInstance.getScience() - 1) / max(1, playerInstance.getScience()));
    ...
    private void setIconForPlayer() {
        Image playerImage = ProfileController.getInstance().getImage(playerInstance.getUser()).getImage();
