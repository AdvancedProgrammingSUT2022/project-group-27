    ...
    private ContextMenu buildContextMenu(Unit unit) {
        ...
        established.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                Message message = Game.getInstance().established(unit);
                showAlert(message);
            }
        });
                    ...
                    public void handle(KeyEvent keyEvent) {
                        if (keyEvent.getCode().equals(KeyCode.ENTER)) {
                            ...
                            try {
                                ...
                                Message message = Game.getInstance().rangedFight(unit, number);
                                showAlert(message);
        ...
        readyRangedFight.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (!unit.getStatus().equals(UnitStatus.AWAKE)) unit.setStatus(UnitStatus.AWAKE);
                Message message = Game.getInstance().readyToRangedFight(unit);
                showAlert(message);
            }
        });
        ...
        plundering.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (!unit.getStatus().equals(UnitStatus.AWAKE)) unit.setStatus(UnitStatus.AWAKE);
                Message message = Game.getInstance().plundering(unit);
                showAlert(message);
            }
        });
        ...
        deleteOrder.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (!unit.getStatus().equals(UnitStatus.AWAKE)) unit.setStatus(UnitStatus.AWAKE);
                String message = Game.getInstance().removeOneOrder(unit);
        ...
        delete.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                Game.getInstance().deleteUnit(unit);
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setHeaderText("Success");
