...
public class LoginView extends Application {
    ...
    public void submit(MouseEvent mouseEvent) throws Exception {
        ...
        if (isSignIn) {
            String message = UserController.getInstance().loginUser(username.getText(), password.getText());
            if (!message.equals(Message.LOGIN_SUCCESSFUL.toString())) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
            ...
            String message = UserController.getInstance().createUser(username.getText(), password.getText(), nickname.getText());
            if (!message.equals(Message.CREATE_USER_SUCCESSFUL.toString())) {
                Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setHeaderText("invalid field");
                alert.setContentText(message);
                alert.show();
