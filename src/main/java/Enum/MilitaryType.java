...
public enum MilitaryType {
    ...
    CHARIOTARCHER(60, "Mounted", 3, 6, 2, 4,
            new ArrayList<StrategicResource>(List.of(StrategicResource.HORSE)), TechnologyType.THE_WHEEL, GlobalVariables.getImagePattern("CHARIOTARCHER/units/WORKER.png")),
    ...
    WARRIOR(40, "Melee", 6, 0, 0, 2,
            new ArrayList<StrategicResource>(), null, GlobalVariables.getImagePattern("images/units/WARRIOR.png")),
    ...
    LONGSWORDSMAN(150, "Melee", 18, 0, 0, 3,
            new ArrayList<StrategicResource>(List.of(StrategicResource.IRON)), TechnologyType.STEEL, GlobalVariables.getImagePattern("LONGSWORDSMAN/units/WORKER.png")),
    ...
    CANON(250, "Siege", 10, 26, 2, 2,
            new ArrayList<StrategicResource>(), TechnologyType.CHEMISTRY, GlobalVariables.getImagePattern("images/units/CANON.png")),
