...
public enum StrategicResource {
    ...
    StrategicResource(int food, int production, int gold, ArrayList<GroundType> groundTypes,
                      ArrayList<FeatureType> groundFeatureTypes, ImprovementType improvement, TechnologyType technology) {
        this.food = food;
